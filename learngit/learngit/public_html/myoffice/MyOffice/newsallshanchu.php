      ...
      border=1>
              <TBODY>
                <TR>
                  ...
                  <TH class=gridViewHeader scope=col>图片1</TH>
                  <TH class=gridViewHeader scope=col>图片2</TH>
                ...
                ?>
                <TR>
                  <TD class=gridViewItem><?php echo $info['nr1'];?></TD>
                  <TD class=gridViewItem><?php echo $info['nr2'];?></TD>
                  <TD class=gridViewItem><?php echo $info['nr3'];?></TD>
                 <TD class=gridViewItem><img src="../../<?php echo $info['pic1'];?>"></TD>
                  <TD class=gridViewItem><img src="../../<?php echo $info['pic2'];?>"></TD>
                  <td  class=gridViewItem><a href="newsallgengxin.php?id=<?php echo $info['id'];?>">更新</a></td>
                   <TD class=gridViewItem><a href="javascript:if(window.confirm('确定删除该信息？')==true)
             {window.location.href='newsallshanchu1.php?id=<?php echo $info['id'];?>'}">删除</a></TD>
              </tr>
              <?php
