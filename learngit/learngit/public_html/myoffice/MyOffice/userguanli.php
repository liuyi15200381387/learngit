...
<form >
      ...
      border=1>
            ...
            src="EmployeeMgr.files/bg_users.gif"> </TD>
                  <TD class=gridViewItem><?php echo $info['user'];?></TD>
                  <TD class=gridViewItem><?php echo $info['pass'];?></TD>
            <TD class=gridViewItem><A class=cmdField 
            href='gengxin.php?id=<?php echo $info['id'];?>' >编辑</A></TD>
                  <TD class=gridViewItem><A class=cmdField 
            id=ctl00_ContentPlaceHolder2_GridView1_ctl02_LinkButton1 
            href="javascript:if(window.confirm('确定要删除吗？')==true)
            {window.location.href='delete.php?id=<?php echo $info['id'];?>'}
            ">删除</A> </TD>
                </TR>
               <?php
