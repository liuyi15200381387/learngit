...
<div class="main01">
   <div class="main01-box">
       <p>产品中心<br /><em>Product Center</em></p>
       <ul>
...
<div class="main02">
   <div class="main02-box box-5">
      ...
      ?>
           <li>
             <a href="Productdetails.php"><img src=<?php echo $info['pic'];?> /></a>
             <p><a href="Productdetails.php"><?php echo $info['nr'];?></a></p>
          </li>
      <?php
      ...
      ?>
       ...
       <div class="Jump">
        ...
        <a href=ProductCenter.php?page=1>首页</a>
        <a href=ProductCenter.php?page=<?php if($page!=1){echo $page-1;}else{echo $page;}?>>上一页</a>
        <?php
          for($i=1;$i<=$pages;$i++){
        ?>
              <a href=ProductCenter.php?page=<?php echo $i ;?>><?php echo $i;?></a>
        <?php
          }
        ?>
        <a href=ProductCenter.php?page=<?php if($page!=$pages){echo $page+1;}else{echo $pages;}?>>下一页</a>
        <a href=ProductCenter.php?page=<?php echo $pages;?>>尾页</a>
         <span>跳转到</span><select name='select' onchange="window.location.href=this.value">
          <option value='1' checked>请选择</option>
           <?php
          for($i=1;$i<=$pages;$i++){
          ?>
          <option value=ProductCenter.php?page=<?php echo $i;?>>第<?php echo $i;?>页</option>
          <?php
        }
          ?>
        </select> 
